 ...
 * <ul>
 *   <li>No circular dependencies between layers or modules</li>
 *   <li>Proper abstraction layers are not bypassed</li>
 *   <li>Internal packages are not accessed externally</li>
 * </ul>
 */
public final class DependencyRules {
    ...
    public static ArchRule apiShouldNotDependOnImplementation(String basePackage) {
        return noClasses()
                .that().resideInAPackage(basePackage + "..api..")
    ...
    public static ArchRule internalPackagesNotAccessedExternally(String basePackage) {
        return noClasses()
                .that().resideOutsideOfPackage(basePackage + "..internal..")
                .should().dependOnClassesThat().resideInAPackage(basePackage + "..internal..")
    ...
    public static ArchRule modelsShouldNotDependOnServices(String basePackage) {
        return noClasses()
                .that().resideInAPackage(basePackage + "..model..")
                .should().dependOnClassesThat().resideInAnyPackage(
                        basePackage + "..service..",
    ...
    public static ArchRule exceptionsShouldBeIndependent(String basePackage) {
        return noClasses()
                .that().resideInAPackage(basePackage + "..exception..")
                .should().dependOnClassesThat().resideInAnyPackage(
                        basePackage + "..service..",
                        basePackage + "..repository..",
                        basePackage + "..core..",
