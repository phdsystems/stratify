...
public final class SEARules {
    ...
    public static ArchRule spiLayerDependencies(String basePackage) {
        return noClasses()
                .that().resideInAPackage(basePackage + "..spi..")
                .should().dependOnClassesThat().resideInAnyPackage(
                        basePackage + "..api..",
                        basePackage + "..core..",
                        basePackage + "..impl.."
    ...
    public static ArchRule facadeClassesShouldBeFinal(String basePackage) {
        return classes()
                ...
                .or().areAnnotatedWith("dev.engineeringlab.stratify.annotation.Facade")
    ...
    public static ArchRule providersShouldImplementInterface() {
        return classes()
                .that().areAnnotatedWith("dev.engineeringlab.stratify.annotation.Provider")
                .should().implement(com.tngtech.archunit.base.DescribedPredicate.describe(
                        "an interface",
                        javaClass -> javaClass.getAllRawInterfaces().size() > 0
                ))
