 ...
 *
 * <p>Providers implementing this interface can be automatically discovered and managed by the
 * Stratify framework. Implementations should be annotated with {@link Provider} to enable
 * metadata-based discovery and selection.
 *
...
public interface ProviderBase {
   ...
   *
   * <p>This should match the name in the {@link Provider} annotation if present.
   *
   ...
   *
   * <p>Higher values indicate higher priority. If a {@link Provider} annotation is present, its
   ...
   *
   * <p>Override to perform setup tasks like loading configuration or establishing connections.
   */
