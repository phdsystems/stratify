 ...
 *
 * <ol>
 *   <li>Classpath: stratify.properties
 *   <li>Working directory: stratify.properties
 *   <li>User home: ~/.stratify/stratify.properties
 * </ol>
 *
 * <p>Example usage:
 *
  ...
  private static void loadFromPath(Path path, StratifyConfig.Builder builder) {
    try (InputStream is = Files.newInputStream(path)) {
      ...
      throw new StratifyException(
          ErrorCode.CONFIG_LOAD_FAILED, "Failed to load configuration from " + path, e);
    }
  }
}
