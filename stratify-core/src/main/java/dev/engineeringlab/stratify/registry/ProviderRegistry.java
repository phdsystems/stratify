 ...
 * <ul>
 *   <li>Priority-based default selection</li>
 *   <li>Automatic extraction of {@link Provider} annotation metadata</li>
 *   <li>Health-aware provider selection</li>
 * </ul>
 *
 * <p>Example usage:
 * <pre>
...
public class ProviderRegistry<P> {
    ...
    public ProviderRegistry<P> register(P provider) {
        ...
        if (annotation == null) {
            throw new StratifyException(ErrorCode.INVALID_PROVIDER_NAME,
    ...
    public P getDefaultOrThrow() {
        return getDefault().orElseThrow(() ->
            new StratifyException(ErrorCode.REGISTRY_EMPTY));
    }
    ...
    public P getOrThrow(String name) {
        return get(name).orElseThrow(() ->
            new StratifyException(ErrorCode.PROVIDER_NOT_FOUND, name));
    }
