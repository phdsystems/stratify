 ...
 *
 * <p>Types marked with {@code @Internal} are not part of the public API
 * and may change or be removed without notice. Consumers should not
 * depend on these types directly.
 *
 * <p>This annotation serves as documentation and enables tooling to:
 * <ul>
 *   <li>Generate warnings when internal types are used externally</li>
 *   <li>Exclude internal types from public API documentation</li>
 *   <li>Validate that internal types are not leaked through public APIs</li>
 * </ul>
 *
 * <p>Example usage:
 * <pre>
 ...
 * </pre>
 *
 * <p>Note: For JPMS modules, use {@code exports ... to} for compile-time
 * enforcement. This annotation provides additional runtime metadata and
 * tooling support.
 */
