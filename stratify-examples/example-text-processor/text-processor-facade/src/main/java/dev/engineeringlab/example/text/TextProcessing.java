 ...
 *
 * <p>This class provides a simplified, static API for common text processing tasks. It
 * automatically discovers and manages TextProcessor implementations.
 *
 * <p>Example usage:
 *
 * <pre>
...
public final class TextProcessing {
  ...
  static {
    ...
    ProviderRegistry<TextProcessor> registry = ProviderDiscovery.loadRegistry(TextProcessor.class);
